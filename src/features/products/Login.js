        ...
        <>
            ...
            <form onSubmit={formik.handleSubmit  }>
                <div >
                    <input 
                        type="text" 
                        name="email" style={{height:"50px",width:"900px", left:"300px",border:"5px solid black", fontWeight:"bolder"}}
                ...
                <div>
                    <input 
                        type="password" style={{height:"50px",width:"900px", left:"300px", border:"5px solid black"}}
